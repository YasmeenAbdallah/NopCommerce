...
{
    public partial class BestSellingViewComponent : NopViewComponent
    {
        ...
        public BestSellingViewComponent(CatalogSettings catalogSettings,
